    ...
    for listener in response['Listeners']:
        ...
        if elb_type == 'gateway':
            ...
            for listener_actions in listener['DefaultActions']:
                ...
                if listener_actions['Type'] == "forward":
                    ###
                    ...
                    elb_target_group_name.append('-')
                    elb_target_group_protocol.append('-')
                    elb_target_group_port.append('-')
                    elb_target_group_health_protocol.append('-')
                    elb_target_group_health_port.append('-')
                    elb_target_group_health_path.append('-')
